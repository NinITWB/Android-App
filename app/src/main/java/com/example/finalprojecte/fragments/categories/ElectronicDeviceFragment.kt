...
@AndroidEntryPoint
class ElectronicDeviceFragment : FragmentBaseCategories() {
    @Inject
    lateinit var firestore: FirebaseFirestore

    val viewModel by viewModels<CategoryViewModel> { CategoryViewModelFactory(firestore, Categories.ElectronicDevice) }
